...
//     function addPool(address _stakedToken, address _lpToken, bool _withdrawable, uint256 _allocPoint, bool _manualAllocPoint) public governanceLevel(2) {
...
//     function setPoolAllocPoints(uint256 _pid, uint256 _allocPoint, bool _withUpdate) public governanceLevel(2) {
...
//     function setPoolTokenType(uint256 _pid, bool _isFotToken, bool _isLpToken, bool _manualAllocPoint) public {
//         poolInfo[_pid].isFotToken = _isFotToken;
//         poolInfo[_pid].isLpToken = _isLpToken;
//         poolInfo[_pid].manualAllocPoint = _manualAllocPoint;
//     }
    
//     function activateDeactivatePool(uint256 _pid, bool _active) public governanceLevel(2) {
...
//         IERC20(pool.stakedToken).transferFrom(address(this), Treasury, stakingFeeAmount); //GET ALL TOKENS FROM USER
...
//         if(wETHBought != 0){IVault(Treasury).buyDFTWithETH();}
